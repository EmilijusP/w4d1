...
public partial class AnagramDbContext : DbContext
{
    ...
    public virtual DbSet<VWordsInfo> VWordsInfos { get; set; }

    public virtual DbSet<Word> Words { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=AnagramSolver;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Categori__3214EC0788772859");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SearchLo__3214EC07D663542A");
        ...
        modelBuilder.Entity<VWordsInfo>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vWordsInfo");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Words__3214EC0786044F42");
